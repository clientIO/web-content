...
**We've published a new demo:** [**Clipboard API Integration**](https://www.jointjs.com/demos/clipboard-api-integration)
...
See the Pen [JointJS+: Clipboard API Integration](https://codepen.io/jointjs/pen/oNyONXp) by JointJS ([@jointjs](https://codepen.io/jointjs))
