...
[JointJS+](https://www.jointjs.com/) is a commercial diagramming library built for embedding into web applications. Unlike standalone modeler tools, it's designed to be extended — you define your own shapes, wire up custom property panels, and control the full editing experience programmatically. It ships with a [BPMN Editor demo](https://www.jointjs.com/demos/bpmn-editor) that implements the complete BPMN 2.0 notation out of the box: a drag-and-drop stencil, an inspector panel with Content and Appearance tabs, a minimap, keyboard shortcuts, and bidirectional BPMN XML import/export.
...
The goal is a proof-of-concept that connects the [JointJS+ BPMN Editor](https://www.jointjs.com/demos/bpmn-editor) to a self-hosted Camunda 8 instance. Concretely, the modeler should:
...
3. ‍**Middleware bridge** — A thin server sits between the browser and Camunda, translating HTTP calls into Zeebe gRPC operations and handling OAuth authentication.
...
For the full working implementation, see the [demo source code on GitHub](https://github.com/clientIO/joint-demos/tree/main/bpmn-camunda-integration).
...
Can you build a custom BPMN modeler UI for Camunda?

Why use JointJS+ instead of Camunda Modeler?

How does a custom modeler communicate with Camunda?

Why is a middleware server necessary?

What modifications are required to make JointJS BPMN XML executable in Camunda?

How are Camunda-specific properties preserved when loading BPMN back into the editor?

How are Camunda connectors modeled in the custom editor?

Can everything be done via REST instead of gRPC?

What is the hardest part of building a custom BPMN modeler for Camunda?