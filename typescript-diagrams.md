---
source: https://www.jointjs.com/typescript-diagrams
generated: 2026-03-22
format: markdown
---

# Create interactive diagrams with TypeScript using a professional library

Leverage the type definitions included with our powerful diagramming toolkit to build AI-powered visual applications.

[start free trial](/free-trial)

## One library, unlimited UIs

Enjoy AI workflow editors, mind maps, kanban boards and other diagramming studios directly inside your Typescript application. Benefit from our app templates and reduce your development time to days.
...
## Seamless integration of JointJS+ & TypeScript
...
Speed up your development and debugging. Utilize our set of type definitions and enhance your TypeScript application with interactive diagramming functionalities.

[read our tutorial](https://docs.jointjs.com/learn/integration/typescript)

### Explore the TypeScript integration with our flowchart app

Use our flowchart maker, built according to integration best practices, to experience the integration of JointJS+ and TypeScript.
