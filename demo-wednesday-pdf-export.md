---
source: https://www.jointjs.com/blog/demo-wednesday-pdf-export
generated: 2026-04-05
format: markdown
---

We've published a new demo: [PDF Export](https://www.jointjs.com/demos/pdf-export)

How to export a diagram along with other information to PDF? [This CodePen does so](https://codepen.io/jointjs/pen/NWMjeBm/36811160158fb89f4f2c3f9d49c2a425) with the help of the great [jsPDF](https://github.com/parallax/jsPDF) library and the export to canvas feature of JointJS.

See the Pen [JointJS+: PDF Export](https://codepen.io/jointjs/pen/NWMjeBm) by JointJS ([@jointjs](https://codepen.io/jointjs))
