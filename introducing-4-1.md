...
👉 This release brings many updates, and we will briefly go through them in this blog post. If you want to dig into all the technical details, [read the full changelog.](https://docs.jointjs.com/learn/release-notes/4.1.0/)
...
#### BPMN Pools, Swimlanes and Milestones
...
👉 [Play with the demo app](https://www.jointjs.com/demos/bpmn-pools-swimlanes-milestones)

**🟧 New BPMN2 shapes**: We've also added several new shapes (horizontal and vertical) for composable BPMN2 pools: *Pools*, *Pools without header*, *Swimlanes* and *Phases*. [Explore all of them here.](https://docs.jointjs.com/learn/release-notes/4.1.0/#shapes-BPMN2-poolsSwimlanesPhases)
...
👉 [Play with the demo app](https://www.jointjs.com/demos/sheet-cutting)
...
👉 [Play with the demo app](https://www.jointjs.com/demos/theory-of-change)
...
👉 [Explore what's new in the Halo plugin](https://docs.jointjs.com/learn/release-notes/4.1.0/#halo)
...
👉 [Explore what's new in the Selection plugin](https://docs.jointjs.com/learn/release-notes/4.1.0/#selection)

### Refactor of the Force Directed layout

Exceed user expectations with the improved Force Directed layout algorithm. Now more customizable and interactive, it organizes elements visually while enhancing performance with [Barnes-Hut approximation](https://en.wikipedia.org/wiki/Barnes%E2%80%93Hut_simulation) (especially for a large amount of cells). Real-time interactions and dynamic updates, like adding new elements, are seamlessly supported.
...
👉 [Explore what's new in the Force Directed layout](https://docs.jointjs.com/learn/release-notes/4.1.0/#forcedirected)

### Introduced a drop-in replacement graph optimized for spatial queries

In many applications, searching for cells based on spatial properties is crucial, such as finding all cells within a rectangle. While a naive approach iterates through all cells, **JointJS+ optimizes this process with the SearchGraph class**, using a [quadtree](https://en.wikipedia.org/wiki/Quadtree) to index cells by their bounding boxes. This drop-in replacement for JointJS Graph enhances performance without requiring code changes.

In the demo below, SearchGraph continuously identifies elements within the selection region as the user drags the mouse.

‍

👉 [Explore more about SearchGraph](https://docs.jointjs.com/learn/release-notes/4.1.0/#searchgraph)

### Advanced visualization using custom SVG attributes
...
👉 [Learn more about custom SVG attributes](https://docs.jointjs.com/learn/release-notes/4.1.0/#dia-CellView-specialPresentationAttributes)

### Other changes

#### 🆕**Support for custom interactions with Stencil**

The new `dragThreshold` option lets you delay the start of dragging, enabling actions such as selecting elements in the stencil, opening a menu, or performing other custom behaviors.

‍

👉 [Explore more about the improved Stencil](https://docs.jointjs.com/learn/release-notes/4.1.0/#stencil)
...
👉 [Explore more about new link tools and options](https://docs.jointjs.com/learn/release-notes/4.1.0/#linktools)

#### 🆕 Export/Import to Visio & BPMN
...
👉 [Explore more about Visio & BPMN Export/Import](https://docs.jointjs.com/learn/release-notes/4.1.0/#format)

#### ⚙️ Intuitive element resizing
...
To enable this feature, simply activate `useBordersToResize` option on your `FreeTransform`.

‍

👉 [Explore more about this update](https://docs.jointjs.com/learn/release-notes/4.1.0/#freetransform)

#### ⚙️ Control the level of detail in exported JSON
...
👉 [Explore more about this update](https://docs.jointjs.com/learn/release-notes/4.1.0/#graph)
...
[Read full changelog](https://docs.jointjs.com/learn/release-notes/4.1.0/)

### Next steps?

Ready to build with the latest version of our library? After reading the [changelog](https://docs.jointjs.com/learn/release-notes/4.1.0/), take one of these routes to get started:
