...
[Silo Team](https://www.silo.team/), a Swedish startup, tackles the issue of the high turnover rate among developers which is one of the highest among all occupations, costing companies billions of dollars annually. Studies show that replacing a developer can cost up to twice their annual salary, meaning the replacement of a developer earning $90,000 per year could cost a company up to $180,000.
...
In order to create a visual and interactive timeline for their onboarding tool, Silo Team needed a powerful diagramming solution. Building this functionality in-house was considered, but it quickly became clear that this approach would be incredibly time-consuming and resource-intensive, diverting their focus from other core product functionalities.

## Solution

**After evaluating several libraries, Silo Team chose JointJS for its robust feature set, high customizability, and seamless integration with Vue and TypeScript**. JointJS offered the tools they needed to create an engaging and interactive onboarding timeline without the extensive development time required to build such functionality from scratch.

According to Rasmus Stjernström, CEO of Silo Team, *"Implementing JointJS was straightforward, thanks to the comprehensive documentation and support resources available. Our developers were able to quickly customize the pre-built shapes and elements to fit our specific requirements, resulting in a highly interactive and user-friendly timeline. Key features like drag-and-drop functionality, node linking, and dynamic updates enhanced the overall user experience. We saved 40% of development time and created an outstanding new UI thanks to JointJS!"*
