...
- Read through our [full changelog](https://changelog.jointjs.com/plus/3.7.0/changelog).
- Download the update package from the [customer portal](https://my.client.io) (only for customers who subscribed to updates).
- If you have not yet purchased a license or are not subscribed to updates, [start a no-commitment 30-day trial](https://www.jointjs.com/free-trial) or purchase a license through our [online store.](https://www.jointjs.com/pricing)

## JointJS+ 3.7 Key Highlights:

Wondering what are the main updates of version 3.7? Let's go through them! Keep in mind that the list below is only a part of all the changes. For a full rundown of what version 3.7 brings, check out our full changelog ➡️ [https://changelog.jointjs.com/.](https://changelog.jointjs.com/plus/3.7.0/changelog)
...
👉 View the ROI calculator demo to see foreign objects in action: [https://jointjs.com/demos/roi-calculator.](https://jointjs.com/demos/roi-calculator)
...
See the Pen [JointJS+: HTML Stencil](https://codepen.io/jointjs/pen/vYVvjpW/4c6fe23572bb3c0c44193841bfedb686) by JointJS ([@jointjs](https://codepen.io/jointjs))
...
See the Pen [JointJS+: Stencil Drag API](https://codepen.io/jointjs/pen/QWZJyZw/80c282eebfe24146c2a9c7d24bbcf39b) by JointJS ([@jointjs](https://codepen.io/jointjs))
on [CodePen](https://codepen.io).
...
See the Pen [JointJS+: Links in Stencil](https://codepen.io/jointjs/pen/JjmwOmP/cfb869d8fb6e73ec63e56165ec05d630) by JointJS ([@jointjs](https://codepen.io/jointjs))
on [CodePen](https://codepen.io).
...
###### *allowCellInteraction* set totrue*:*
...
Read our full changelog to get a detailed view of the newest release ➡️ [https://changelog.jointjs.com/.](https://changelog.jointjs.com/plus/3.7.0/changelog)

### 👌 New demo applications

In addition to the many exciting updates, we've brought a bunch of new demo apps that are part of v3.7. Let's take a look at a few of them, or [start a 30-day trial and check out their source code](/free-trial).

#### Decision Tree Visualization

AI-driven experiments using reinforcement learning can be visualized as decision trees. To improve clarity, specialized display techniques are essential for handling the complexity of these graphs. Strategies like label reduction, color-coding links based on outcomes, consolidating branch results, and providing detailed information on demand enhance the visualization. Here's an example of a [decision tree](https://www.jointjs.com/demos/decision-tree) using random data.

See the Pen [JointJS+: Decision Tree Visualization](https://codepen.io/jointjs/pen/xxyaPrO) by JointJS ([@jointjs](https://codepen.io/jointjs))
on [CodePen](https://codepen.io).

#### Decision Tree Analysis

Playing a zero-sum game tournament like chess or checkers? Want to maximize your winning chances? Curious about the best strategy to adopt - aggressive or defensive? Explore this demo featuring the layout.TreeLayout plugin, demonstrating how to build a [decision tree analysis diagram](https://www.jointjs.com/demos/decision-tree-analysis).

See the Pen [JointJS+: Decision Tree Analysis](https://codepen.io/jointjs/pen/RweyKxO) by JointJS ([@jointjs](https://codepen.io/jointjs))
on [CodePen](https://codepen.io).

#### ROI calculator

Learn how JointJS efficiently incorporates HTML form elements into shapes using the aforementioned foreign objects. In addition, [this demo](https://jointjs.com/demos/roi-calculator) demonstrates the accessibility of JointJS as it works seamlessly with screen readers.

See the Pen [JointJS: Return of Investment](https://codepen.io/jointjs/pen/oNazJme) by JointJS ([@jointjs](https://codepen.io/jointjs))
on [CodePen](https://codepen.io).

#### Sankey diagram

Discover an exciting way to create interactive [Sankey diagrams](https://www.jointjs.com/demos/sankey-diagram) using link anchors, curve connectors, and stack layout. This JavaScript-based demo provides a simple drag-and-drop interface, making it effortless to generate dynamic and captivating visual representations of your data. Plus, learn a bonus technique for adding watermarks to your diagrams.

See the Pen [JointJS+: Sankey Diagram](https://codepen.io/jointjs/pen/VwGxbKo) by JointJS ([@jointjs](https://codepen.io/jointjs))
on [CodePen](https://codepen.io).

#### Activity diagram

Ever wondered about the intricate process of how a bill becomes law in the US? Our activity diagram breaks down this complex journey. Discover the power of collapsible swimlanes, conditional highlighters, and automatic link reconnect as you navigate through the visual representation of workflows and actions. Unveil the inner workings of legislation and explore our [activity diagram](https://www.jointjs.com/demos/activity-diagram) while at it.
