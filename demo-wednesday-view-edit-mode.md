...
We've published a new demo: [View/Edit Mode](https://www.jointjs.com/demos/view-edit-mode)

Do you need to switch a diagram from read-only to completely editable mode? Do you need to make it dynamic, e.g. based on user permissions? Here is a [CodePen](https://codepen.io/jointjs/pen/ExRvvGb) of how to structure your application to make toggling between **view and edit mode** easier.
