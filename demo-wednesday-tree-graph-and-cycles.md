...
We've published a new demo: [Tree graph and cycles](https://www.jointjs.com/demos/tree-graph-and-cycles)
...
See the Pen [JointJS+: Tree graph and cycles](https://codepen.io/jointjs/pen/LYrQvKZ) by JointJS ([@jointjs](https://codepen.io/jointjs))
