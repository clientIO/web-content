...
Welcome to our blog post, "15 community-designed demo apps: our top picks!" As developers of a diagramming library, we understand that diagramming is not a one-size-fits-all solution. With endless use cases in mind, we actively collect ideas from our customers, community members, and internally to expand [our collection of demo applications](/demos) that can be used out of the box to solve specific requirements. From org charts to sequence diagrams, mind maps to Marey charts, our community has contributed various demo applications that showcase the versatility of JointJS or JointJS+.

In this blog post, we will highlight our top picks from the community-designed demo apps, as well as explore intriguing diagramming features that may initially appear simple to create but become more complex as you delve into building them. We also encourage you to share your ideas and contribute to our growing library of demo applications 👉 [https://github.com/clientIO/joint/discussions.](https://github.com/clientIO/joint/discussions/1643)
...
‍*View the* [*Corporate organizational chart*](https://www.jointjs.com/demos/corporate-organizational-chart) *demo in a new tab.*
...
*View the* [*Sequence diagram*](https://www.jointjs.com/demos/sequence-diagram) *demo in a new tab.*
...
*View the* [*Electric generator*](https://www.jointjs.com/demos/electric-generator) *demo in a new tab.*
...
*View the* [*Marey chart*](https://www.jointjs.com/demos/marey-chart) *demo in a new tab.*
...
*View the* [*Rectangular layout*](https://www.jointjs.com/demos/rectangular-layout) *demo in a new tab.*
...
*View the* [*Hexagonal grid*](https://www.jointjs.com/demos/hexagonal-grid) *demo in a new tab.*
...
*View the* [*Yamazumi 3D*](https://www.jointjs.com/demos/yamazumi-3d) *demo in a new tab.*
...
*View the* [*Bandwidth*](https://www.jointjs.com/demos/bandwidth) *demo in a new tab.*

### 9. Diagram index

Next, see the Diagram index demo written in [React](https://github.com/clientIO/joint-plus-tutorial-react/tree/mui-tree-view), [Vue](https://github.com/clientIO/joint-plus-tutorial-vue/tree/tree-view), [Angular](https://github.com/clientIO/joint-plus-tutorial-angular/tree/angular-material-tree), and [Svelte](https://github.com/clientIO/joint-plus-tutorial-svelte/tree/svelte-tree-view) from a company building a value chain modeling application and showing how to display multiple JointJS diagrams with a TreeView component for seamless navigation. This allowed the company to gain a comprehensive overview of all elements within their diagrams, facilitating organized and efficient work.

*View the* [*Diagram index*](https://www.jointjs.com/demos/diagram-index) *demo in a new tab.*
...
*View the* [*Finite object pool*](https://www.jointjs.com/demos/finite-object-pool) *demo in a new tab.*

### 11. PDF export

Looking for a way to export a diagram with all its contents to PDF? Check out the next demo application that demonstrates this handy feature using the great [jsPDF library](https://github.com/parallax/jsPDF). In addition to PDF, you can also use other file types for export, such as PNG, JSON or our beloved SVG.

*View the* [*PDF export*](https://www.jointjs.com/demos/pdf-export) *demo in a new tab.*
...
*View the* [*Dynamic tooltip content*](https://www.jointjs.com/demos/dynamic-tooltip-content) *demo in a new tab.*
...
*View the* [*List of links in inspector*](https://www.jointjs.com/demos/list-of-links-in-inspector) *demo in a new tab.*
...
*View the* [*Change element text alignment in the inspector*](https://www.jointjs.com/demos/change-element-text-alignment-in-inspector) *demo in a new tab.*
...
*View the* [*Port Drag & Drop*](https://www.jointjs.com/demos/port-drag-drop) *demo in a new tab.*

## Conclusion

We've included 15 examples of apps that were originally designed by our community and built by the JointJS team. We release new demos every week (every Wednesday), so if you're looking for a diagramming library to solve a specific use case, want to visually express some data, or need to see a specific diagramming feature in action, let us know! As stated above, we collect all ideas on Github Discussions, so feel free to add yours 👉 [https://github.com/clientIO/joint/discussions](https://github.com/clientIO/joint/discussions/1643).
