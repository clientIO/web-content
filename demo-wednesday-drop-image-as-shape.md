...
We've published a new demo: [Drop image as shape](https://www.jointjs.com/demos/drop-image-as-shape)

Do you want users to be able to drag and drop an image from their operating system directly into a diagram and turn it into an interactive element? [This is how it could be done](https://codepen.io/jointjs/pen/BaxZdxO/2d84e9e0e2958200c6bd8c96451ef4a6).

See the Pen [JointJS: drop image as shape](https://codepen.io/jointjs/pen/BaxZdxO) by JointJS ([@jointjs](https://codepen.io/jointjs))
