...
client IO s.r.o. ("us", "we", or "our") uses cookies on the https://jointjs.com website (the "Service"). By using the Service, you consent to the use of cookies.  
...
##### How client IO s.r.o. uses cookies
...
\* For the Safari web browser, please visit: https://support.apple.com/kb/PH21411?locale=en\_US  
