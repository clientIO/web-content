...
As ComponentSource explains, [the allocation of the awards has been calculated based on real sales orders placed by ComponentSource customers globally during 2022](https://www.componentsource.com/help-support/bestselling-publisher-awards-2023).
...
If you're considering using JointJS in your project, know that our library is available in two versions: [open-source](https://github.com/clientIO/joint), which makes it easy for solopreneurs and novice developers to incorporate basic diagramming features into their application, and [JointJS+](/jointjs-plus), a professional JavaScript/TypeScript diagramming library that helps companies of any size create advanced visual and No-Code/Low-Code applications. The latter offers a [30-day no-obligation trial](/free-trial), so give it a try!