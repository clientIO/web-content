...
We've published a new demo: [Presentation mode](https://www.jointjs.com/demos/presentation-mode)

Do you want to present a diagram to your users element by element? Do you want them to navigate through the diagram using the presentation toolbar? [Here's a CodePen that does just that](https://codepen.io/jointjs/pen/wvjaQxr).

See the Pen [JointJS+: Presentation Mode](https://codepen.io/jointjs/pen/wvjaQxr) by JointJS ([@jointjs](https://codepen.io/jointjs))
