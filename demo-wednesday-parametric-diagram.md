...
**Systems Modeling Language (SysML)** is a general-purpose modeling language that is used for systems engineering. It extends the [**Unified Modeling Language (UML)**](https://www.jointjs.com/blog/uml-class-diagrams) to include additional diagram types and semantics that are useful for modeling complex systems. *SysML* is designed to support the specification, analysis, design, verification, and validation of a wide range of systems, including hardware, software, information, processes, personnel, and facilities.
...
See the Pen [JointJS+: SysML Parametric Diagram (PAR)](https://codepen.io/jointjs/pen/oNmXyMW/4306e50c9d8b2a52e114cb089dc18f19) by JointJS ([@jointjs](https://codepen.io/jointjs))
