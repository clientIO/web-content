---
source: https://www.jointjs.com/jsplumb-alternative
...
Opt for a fast, feature-rich diagramming library and build AI-powered professional applications with confidence.
...
# JointJS over jsPlumb

#### Fast and flexible technology

JointJS uses SVG best practices, ensuring blazingly fast rendering performance for your visual applications.
...
JointJS offers an extensive set of ready-to-use UI components and advanced diagram interactions, giving you all the building blocks to create professional visual applications.
...
Perpetual unlimited commercial or open source use of the license at no extra cost (e.g. based on number of deployed apps, end-users, and/or machines).
