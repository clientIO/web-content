...
Curious? Have a look at the extensive update description in the [full changelog here](https://changelog.jointjs.com/rappid/3.5.0/changelog).
...
Below, see an example of a Kanban board built with JointJS+. [To play around with the demo yourself, visit this page.](https://www.jointjs.com/demos/kanban)

Impressive, isn't it? Check out Yamazumi too ([live demo available here](https://www.jointjs.com/demos/yamazumi-3d)).

### Scrollbar and data modifier/decorator added to the Data Mapping application

Thanks to the scrollbars, it is no longer a problem to display huge data sets in a single shape. In addition, modifiers/decorators have been added to allow end users to modify the data flowing from one data silo to another. [Check out the live demo to learn more](https://www.jointjs.com/demos/data-mapping).
...
[Check out this live demo to learn more.](https://www.jointjs.com/demos/kitchen-sink-app)
...
If you were wondering how to create an element where the content drives the size of the element, JointJS+ 3.5 is the answer. To learn more about this powerful mechanism, [check out our tutorial](https://www.jointjs.com/demos/content-driven-shapes).

Also, we're updating our [CodePen profile](https://codepen.io/jointjs) where we are adding new tutorials regularly. Here's one we're proud of (Marey's Chart).
...
We hope you'll get the most from the new features and updates. Please don't hesitate to [get in touch](/cdn-cgi/l/email-protection#96f9e4f1d6f5fafff3f8e2b8fff9) with questions or comments.
