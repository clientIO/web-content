...
JointJS is accessible to newcomers thanks to its [**large collection of 160+ demos and boilerplate applications**](https://www.jointjs.com/demos)and[**a comprehensive tutorial path**](https://docs.jointjs.com/learn/quickstart/). At the same time, its [**detailed documentation**](https://docs.jointjs.com/) delights veteran developers who need to get into the nitty-gritty details of the library. For those who need more assistance, JointJS+ offers additional **support subscriptions** with guaranteed SLAs and **access to the original creators of the library**, who can help resolve even the most complex problems. In short, **JointJS is the perfect replacement of mxGraph for** [**teams and companies of any size**](https://www.jointjs.com/success-stories).

When you are ready to make the leap, reach out to us for a [**no-commitment 30-day trial of JointJS**](https://www.jointjs.com/free-trial), and see the power of JointJS for yourself.
