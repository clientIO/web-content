---
source: https://www.jointjs.com/blog/jointjs-vs-bpmn-js-a-technical-comparison-for-production-bpmn-editors
...
- Vendor-provided solutions are [simple to get started with but not flexible enough](https://www.jointjs.com/blog/why-teams-build-custom-bpmn-modeler-uis) to handle many common customization use cases.
- Creating interactive diagrams on the Web [is not straightforward](https://www.jointjs.com/blog/the-complexity-of-diagramming), and developing a custom BPMN modeler UI [presents additional complexity](https://www.jointjs.com/blog/why-building-a-bpmn-modeler-ui-is-harder-than-it-looks). Reinventing the wheel in these areas means contending with intricate issues that may not be immediately apparent to an uninitiated developer (even that developer has access to a frontier AI model for assistance).
...
What support options are available for JointJS and bpmn-js?
