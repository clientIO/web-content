...
We've published a new demo: [External SVG Images](https://www.jointjs.com/demos/external-svg-images)
...
See the Pen [JointJS: External SVG Images](https://codepen.io/jointjs/pen/MWBwMvo) by JointJS ([@jointjs](https://codepen.io/jointjs))
