...
As Y Combinator points out in a [recent video](https://www.youtube.com/watch?v=DBhSfROq3wU), it seemed for a moment that chatting with the computer was the only way an **AI interface** could be designed. Yes, **imitating a human conversation** (instead of a machine control panel as current user interfaces do) was a genuine innovation and a breath of fresh air in the UI design space - in much the same way **touch interfaces** stormed the stage around the year 2010. And for some applications, it was more than enough - LLM chatbots now threaten the stranglehold that Google Search (arguably the pioneer of the simple text box interface) has attained on information retrieval, for example.
...
These autonomous automations (“autonomations”?) can go behind the scenes and [**directly interact with websites and users**](https://youtu.be/DBhSfROq3wU?feature=shared&t=476) - even make phone calls - in order to carry out a task for you or to find the information you need. All of that based on a **few high level instructions**.

For example, [as explained by IBM](https://www.ibm.com/think/topics/ai-agents), if you asked an AI agent “Which week in the next year would likely have the best weather for a surfing trip in Greece?”, the AI agent might:

- Check weather reports for past years in Greece,
- Ask an external AI agent what the best weather conditions are for surfing,
- Combine the information to find the week likely to have the highest tides and sunny weather and report this back to you.
...
- How do we make sure our AI agent **understands** the task?
- How do we **specify** where an AI agent is expected to do work?
- How do we **demarcate** where an AI agent should hand off its work?
...
According to Rafael Schaad in a discussion with Y Combinator, [**today’s predominant user interface language of “nouns”**](https://youtu.be/DBhSfROq3wU?feature=shared&t=50) - i.e. buttons, forms, and dropdowns - is not very well suited for the overseeing of agentic processes. While the process is running, there is nothing for us to control. And when the process is being specified, we are missing a language to specify actions and their connections.
...
As it turns out, there is a way to do it. We just need to **expand to more dimensions**. All this time, in order to move forward we just needed to look back at what was created before, and give a [fresh new twist to a trusty technology of the past](https://youtu.be/DBhSfROq3wU?feature=shared&t=757) - the **flowchart**.

## Modeling AI Processes with Flowcharts

Crucially, flowcharts are [**two-dimensional**](https://youtu.be/DBhSfROq3wU?feature=shared&t=685). They allow us to **map a process** from beginning to end, with all of its twists and turns, separate subtasks, conditional branches and loops. They allow us to **chart the flow** of the whole interaction instead of offering just a single instantaneous point of contact in the here-and-now (as chatbots do). The twist is that [**flowcharts can now be interactive**](https://youtu.be/DBhSfROq3wU?feature=shared&t=781) instead of static as they used to be in the past.

Most importantly, flowcharts allow us to specify **how** something should happen - not only what should happen. [**They allow us to talk in “verbs”**](https://youtu.be/DBhSfROq3wU?feature=shared&t=62) - e.g. “get information for me”, “autocomplete”, “autosuggest”, etc. In effect, flowcharts allow us to **collaborate** with the computer, instead of commanding it.

Previously, the only people who needed to know flowcharts were business analysts and software engineers, but with the rise of AI applications, [**flowcharts have emerged as an exceptionally suitable way to model AI processes**](https://youtu.be/DBhSfROq3wU?feature=shared&t=566). **They are becoming relevant for everyone** - from salespeople and HR managers to accountants and marketing specialists.

This is demonstrated by the growing number of **AI applications that use flowcharts** as the core of their user interface, enabling users to set up diverse AI agent experiences: [Appmixer](https://appmixer.webflow.io), [n8n](https://n8n.io), [Lindy](https://www.lindy.ai), [VectorShift](https://vectorshift.ai), [Langflow](https://www.langflow.org), [Postman AI Agent Builder](https://www.postman.com/product/ai-agent-builder/), [FlowiseAI](https://flowiseai.com), [Botpress](https://botpress.com), [FlowGent AI](https://flowgent.ai), [Flowpoint](https://flowpoint.ai), or [Relay.app](https://www.relay.app), to name just a few.  
  
‍

‍

## Implementing a Flowchart UI

It used to be the case that most applications didn’t need a flowchart builder - it was a relatively niche feature that was required primarily for modeling business processes, laying out network diagrams or preparing call flows. However, with the shift of how applications will look in the AI agent era, it is clear that **flowcharts will become much more relevant for many more applications from a wider variety of industries**. According to Y Combinator, 10 years from now, [**flowchart interfaces may become the standard way to interact, control and monitor AI agents**](https://youtu.be/DBhSfROq3wU?feature=shared&t=735).

If you are looking to contribute to the scramble and **take your application to the next level with AI**, you should consider using [**JointJS**](https://www.jointjs.com) for the front-end of your agentic interface. It is a **mature open-source diagramming library** which provides the building blocks to create flowcharts that match the look-and-feel of your application in no time. When paired with [**JointJS+**](https://www.jointjs.com/jointjs-plus) (the paid extension of JointJS), it allows you to create **powerful application interfaces** that include zooming and panning, property viewing and editing and advanced element interactions.
...
[Open the AI Agent Builder app in a new tab and try it out!](https://www.jointjs.com/demos/ai-agent-builder) You start by **choosing a trigger** for your flow, then continue by adding different **actions and control components** in the interactive diagram area in the center. You can tweak existing actions by selecting them and modifying their configuration in the **property editor and viewer** on the right.
...
If you are thinking about creating your own AI agent interface, JointJS is here to smooth this path for you - we would like to extend to you an [**invitation to a no-commitment 30-day trial of JointJS**](https://www.jointjs.com/free-trial). It will allow you to experience the advanced JointJS+ features for yourself, get started quickly using 170+ demo applications and feature examples, and explore how its features can be seamlessly integrated with your application.
