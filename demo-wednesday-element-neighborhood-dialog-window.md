...
**We've published a new demo:** [**Element Neighborhood Dialog Window**](https://www.jointjs.com/demos/element-neighborhood-dialog-window)
...
See the Pen [JointJS+: Element Neighborhood Dialog Window](https://codepen.io/jointjs/pen/oNJVepR) by JointJS ([@jointjs](https://codepen.io/jointjs))
