...
For those of you interested in the beautiful story, let's continue. In 2010, our [founder and CEO David Durman](https://www.linkedin.com/in/daviddurman/) released the open-source library JointJS with a mission to help developers create visual applications more efficiently.

As time went on, more and more developers were using the open-source library, and it became clear that there was an opportunity for further development and growth. That's when David Durman and [Roman Brückner](https://www.linkedin.com/in/roman-bruckner-ba84926b/), who got excited about the project and joined as a co-founder, came up with Rappid - an extension of JointJS. That year, the company [client IO s r.o.](https://www.client.io/) was founded.
...
By the way, if you want to take a look at the evolution of JointJS and Rappid, [check out our post listing all the logos and names](https://www.jointjs.com/blog/a-complete-site-logo-redesign) we've used over the years.
...
- The change will have no impact on the functionality of the framework.
- In the coming weeks, we'll be launching a new logo, website, and other supporting materials that clearly outline the benefits of JointJS (open-source) and JointJS+ (a commercial extension with enhanced functionality).
- The company behind JointJS and JointJS+ remains unchanged (client IO s.r.o.)
- For communication purposes, we'll use emails ending with @jointjs.com.
...
> *“I am excited that we are improving not only on the product level, but also in our communication with customers and the community. It has always been our number one priority to be a valuable partner in their journey to success, and clear communication certainly plays an important role in that mission.”* [*Roman Brückner, CTO*](https://www.linkedin.com/in/roman-bruckner-ba84926b/)

Interested in being part of the community? [Join the community on Github](https://github.com/clientIO/joint), feel free to ask any question or even contribute (thanks for that!).

If you haven't experienced the power of JointJS+ yet, [you can start a 30-day risk-free trial](https://www.jointjs.com/free-trial) and play around with the solution yourself.

## **Frequently asked questions**

### **1. I am a Rappid customer and have an active license. Do these changes affect me?**

No, nothing changes for you. Your license will still be active, available on our customer portal: [https://my.jointjs.com](https://my.client.io). The change of brand does not affect the functionality of the framework.

### **2. Are the support terms changing?**
...
### 3. **Will JointJS still offer the same features?**

Yes, this change will not affect the functionality of the open-source JointJS library.

### 4. **Is JointJS still free?**

Of course! JointJS will remain free and will always be our way of giving back to the developer community.

### 5. **How can I get involved in the community?**

We're glad you asked! We're improving the way we use [our Github repository](https://github.com/clientIO/joint). Now, you can join the discussions there, ask any questions or even make a contribution.
