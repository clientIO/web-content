...
- Read through our [full changelog](https://changelog.jointjs.com/rappid/3.6.0/changelog?_ga=2.108709259.848132100.1666175490-945529044.1625654826&_gl=1*1pvlrmh*_ga*OTQ1NTI5MDQ0LjE2MjU2NTQ4MjY.*_ga_S3PN155Z28*MTY2NjM2Mjk3MS4xOTAuMS4xNjY2MzY0NTM2LjAuMC4w).
- Download the update package from the [Account portal](https://my.client.io) (only for customers who subscribed to updates).
...
You can [view the live demo here](https://www.jointjs.com/demos/mindmap) or watch a guide on how to use and edit the MindMap application:
...
[Read through our documentation](https://resources.jointjs.com/docs/rappid/v3.6/shapes.vsm.html) to learn how to work with VSM shapes.
...
See the Pen [JointJS: dynamic status icons](https://codepen.io/jointjs/pen/JjvQBLq/64bf289dac742d85f0890ebe383b6a17) by JointJS ([@jointjs](https://codepen.io/jointjs))
on [CodePen](https://codepen.io).

- Counters used in data flow diagrams.

See the Pen [JointJS: HighlighterView UPDATE\_ATTRIBUTE](https://codepen.io/jointjs/pen/jOxRGOM/1b42c6a365bd626c889a40051d005b71) by JointJS ([@jointjs](https://codepen.io/jointjs))
on [CodePen](https://codepen.io).
...
We'll list some of the key component upgrades below, but we encourage you to [read our full changelog](https://changelog.jointjs.com/rappid/3.6.0/changelog) to find out about all changes.
...
Need proof instead of words? [Try it out in the Kitchen Sink demo app](https://www.jointjs.com/demos/kitchen-sink-app).
...
See the Pen [JointJS+: ui.ContextToolbar - open at position & scale and anchor options](https://codepen.io/jointjs/pen/ExLzJKV/56f7a4eb36ccbb379120e122ca693984) by JointJS ([@jointjs](https://codepen.io/jointjs))
on [CodePen](https://codepen.io).

Want to see how to change the popup?

See the Pen [JointJS+: ui.Popup - position, scale, anchor, arrowPosition options](https://codepen.io/jointjs/pen/PoevLOp/49a73d4d515be670d116241bc1a79b82) by JointJS ([@jointjs](https://codepen.io/jointjs))
on [CodePen](https://codepen.io).

### Improved ui.Clipboard that helps you copy/paste multiple elements

We improved the ui.Clipboard component, which allows you to copy/paste multiple elements, insert clipboard cells at a given point, and pass custom model flags. [See the full changelog for more information](https://changelog.jointjs.com/rappid/3.6.0/changelog).

### A new linking tool displayed on hover that allows more flexible linking

In most cases, you may want to link different objects together to symbolize a data flow, a production process, or simply a relationship between these objects. However, there are cases where you need to connect links ([see this sequence diagram, for instance](https://www.jointjs.com/demos/sequence-diagram)). With the new version of JointJS+ and the new **linkTools.HoverConnect** component, you can move over an existing link and create connections with more flexibility.

[View the live demo here](https://www.jointjs.com/demos/sequence-diagram).
...
[View the live demo here](https://www.jointjs.com/demos/rich-text-editor).
...
See the Pen [JointJS+: ui.Halo: clone & fork nested cells](https://codepen.io/jointjs/pen/poVXVOM/2c4e220fafd9a0b393b4a69e37d3246b) by JointJS ([@jointjs](https://codepen.io/jointjs))
on [CodePen](https://codepen.io).
...
See the Pen [Tool scale option](https://codepen.io/jointjs/pen/OJZderr/89195c8b86376ba29407607087767dc6) by JointJS ([@jointjs](https://codepen.io/jointjs))
on [CodePen](https://codepen.io).

### Other additions

Besides the key highlights mentioned above, [we have prepared a plenty of other updates](https://changelog.jointjs.com/rappid/3.6.0/changelog?_ga=2.108709259.848132100.1666175490-945529044.1625654826&_gl=1*1pvlrmh*_ga*OTQ1NTI5MDQ0LjE2MjU2NTQ4MjY.*_ga_S3PN155Z28*MTY2NjM2Mjk3MS4xOTAuMS4xNjY2MzY0NTM2LjAuMC4w) you may be interested in, including **RTL direction support** and **memory leak fix**.

#### RTL direction support

We've fixed scrolling when the [directionality of the text](https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes/dir) is set to right-to-left (typical for Arabic languages and Hebrew).
