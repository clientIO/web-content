...
We've published a new demo: [Shapes Drawing](https://www.jointjs.com/demos/shapes-drawing)

How to allow your users to **draw** different **shapes** using their pointer device? Check out our new [CodePen](https://codepen.io/jointjs/pen/OJvMpyL) example.
