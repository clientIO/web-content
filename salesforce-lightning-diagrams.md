...
# Enrich your Salesforce Lightning environment with interactive diagrams

Leverage the efficient component-based architecture of Salesforce Lightning combined with our powerful diagramming toolkit to build AI-powered visual applications.

[start free trial](/free-trial)

## One library, unlimited UIs

Enjoy AI workflow editors, mind maps, kanban boards and other diagramming studios directly inside your Salesforce Lightning app. Benefit from our app templates and reduce your development time to days.
...
## Seamless integration of JointJS+ & Salesforce Lightning

See the integration in action, demonstrated on a simple communication. With the code below, we add a counter that shows number of cells in the graph and a button to clear the graph.

Our approach to integration is simple yet easily scalable. Include JointJS+ code anywhere in your Salesforce Lightning application and enhance any component with advanced functionality.

[read our tutorial](https://changelog.jointjs.com/rappid/tutorials/lightning)
