...
The most fundamental difference between the two libraries is perhaps the most basic – the way they surface your diagrams to your webpages. **JointJS uses SVG rendering** ([<svg> tag](https://developer.mozilla.org/en-US/docs/Web/SVG/Element/svg)), while **GoJS primarily relies on HTML Canvas element** ([<canvas> tag](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/canvas)). Each approach has its own pros and cons, and each library does its best to offer similar performance to the other. (Both libraries also enable you to export your diagrams to the other format.)
...
| Feature | JointJS | GoJS |
| --- | --- | --- |
| Image and text rendering quality | 👍 | 🙁\* |
| Native browser functionality | 👍 | 👎 |
| CSS styling and animations | 👍 | 👎 |
| Automated testing for production environments | 👍 | 👎 |
| Accessibility | 👍 | 🙁 |
| Performance | 👍\*\* | 👍 |
| Vector-based SVG rendering without sacrificing performance | 👍\*\* | 👎 |
...
Some of the JointS+ alternatives seemed to be easier to use for our developers with Java background at first glance, but when we tried to implement something which did not come out of the box, it was complicated. In addition, design and styling would be hard because oftentimes it was canvas-based.

Johanna Juszak

Product Manager at ConSol

First, being **able to use native CSS functionality** means that **SVG and JointJS can work in tandem with complex** [**CSS animations**](https://developer.mozilla.org/en-US/docs/Web/CSS/animation). GoJS falls notably short here – it mimics the functionality via JavaScript for only a handful of the most popular CSS animatable properties, but even that requires writing custom code which is opaque to uninitiated front-end developers.
...
👉 [Live performance demo](https://docs.jointjs.com/learn/release-notes/4.2.0#ui-PaperScroller-virtualRendering)
...
| Feature of standard license\* | JointJS | GoJS |
| --- | --- | --- |
| Perpetual license | ✔ |  |
| License cost is based on number of developers | ✔ | ✔ |
| No additional license cost for distribution on more than 1 domain | ✔ |  |
| No additional license cost for use within more than 1 application | ✔ |  |
| One year of free updates included with license | ✔ | ✔ |
| Additional yearly subscription for additional updates is available | ✔ |  |
| Additional yearly subscription for basic support is available | ✔ |  |
| Additional yearly subscription for priority support is available | ✔ |  |

\* By “standard license” we mean JointJS+ Standard plan for JointJS and GoJS Team license for GoJS

## Community and Support

An active (and ideally free) community is a strong asset for developers trying to find their way around any new technology. That is why both JointJS and GoJS are active across a number of channels. Both libraries have a fairly active community on **StackOverflow** – [JointJS](https://stackoverflow.com/questions/tagged/jointjs) and [Rappid](https://stackoverflow.com/questions/tagged/rappid) (old brand name of JointJS+) are tagged in 702 questions, while [GoJS](https://stackoverflow.com/questions/tagged/gojs) is tagged in only 431 questions (with both around 90% answered).

Both libraries also monitor their **GitHub Issues**. JointJS has an edge on this support channel as well, with [759](https://github.com/clientIO/joint/issues?q=is%3Aissue+is%3Aclosed) of these conversations in total, while GoJS had only [169](https://github.com/NorthwoodsSoftware/GoJS/issues?q=is%3Aissue+is%3Aclosed) (with both more than 95% answered). Additionally, JointJS has an active **GitHub Discussions** forum, while GoJS promotes their **GoJS forum** – with the unusual caveat that **asking questions is a paid feature**. **JointJS’s support is more accessible** by virtue of not locking out any of its users from asking questions on its official forum.

| Free support channel | JointJS | GoJS |
| --- | --- | --- |
| StackOverflow | ✔ | ✔ |
| GitHub Issues | ✔ | ✔ |
| Read public discussion forum\* | ✔ | ✔ |
| Post questions on public discussion forum\* | ✔ |  |
...
| Paid support channel | JointJS | GoJS |
| --- | --- | --- |
| Email | ✔ | ✔ |
| Post questions on public discussion forum\* | ✔ \*\* | ✔ |
| Teleconferencing | ✔ |  |
| Ticketing system with short response times | ✔ |  |
...
## Demos and Boilerplate Applications
...
One thing JointJS customers love about its demo collection is that it isn’t just an index of library functionality. **Many JointJS demos serve as boilerplate applications**, meaning that they can serve as the foundation on top of which you can build your own application. The source code of [**more than 40 of these advanced demos**](https://docs.jointjs.com/learn/help-center/what-is-included#apps-in-the-jointjs-package) is included as part of JointJS+ – including the free trial version.
...
Project Manager at Nov Inesc Inovação
...
- If your users expect native browser functionality such as full-page search to work within your diagrams.
- If you need to iterate quickly and provide your developers with technology that is easy to test and debug, without worrying about differences between testing and production environments.
- If you need granularity in licensing, update, and support plans.
- If privacy is of utmost importance to you and support requests cannot be handled through any insecure channel.
- If you need to process advanced diagramming formats such as Visio VSDX archives and BPMN 2.0 XML files.
...
| Feature | JointJS | GoJS |
| --- | --- | --- |
| Embedding diagrams into your webpage | ✔ | ✔ |
| Development in JavaScript and TypeScript | ✔ | ✔ |
| Integration with React, Vue, Angular and Svelte | ✔ | ✔ |
| Straightforward development in production environment  - All objects present in website DOM - Support for native browser behaviors - Easy manual and automated testing - Easy diagram styling (CSS) - Easy diagram animations (CSS) - Easy implementation of accessibility - Uses JavaScript best practices | ✔ |  |
| Ability to render large numbers of objects | ✔ | ✔ |
| Vector-based SVG rendering without sacrificing performance | ✔ |  |
| Free updates for 1 year are part of standard license | ✔ | ✔ |
| No restrictions on use of standard license | ✔ |  |
| Granularity in update and support plans | ✔ |  |
| Free and active outside support communities | ✔ | ✔ |
...
| Free tier with basic diagramming functionality | ✔ |  |
| Seamless integration between free tier and paid tier | ✔ |  |
| Free 30-day trial period | ✔ | ✔ |
| Full support during trial period | ✔ | ✔ |
| Basic diagram shapes  - Elements - Links | ✔ | ✔ |
| Custom diagram shapes | ✔ | ✔ |
| BPMN diagram shapes | ✔ | ✔ |
| VSM diagram shapes | ✔ |  |
| Basic UI elements  - Minimap - Element palette - Context menu - Tooltip - Measurement tools - Property editor and viewer | ✔ | ✔ |
| Advanced UI elements  - Toolbar - Inline rich text editor - SVG path editor - Snaplines | ✔ |  |
| Basic interactions  - Keyboard shortcuts - Copy/paste - Undo/redo - Object selection - Scroll, zoom and pan - Printing tools | ✔ | ✔ |
| Advanced interactions  - Presentation tools (slideshows) | ✔ |  |
| Basic object layout algorithms  - Layered (flowchart) - Tree (orgchart) - Force-directed - Grid (table) - Stack - Circular / Spiral / Serpentine - Packed | ✔ | ✔ |
| Niche object layout algorithms  - Radial / Treemap |  | ✔ |
| Basic export functionality  - SVG - HTML Canvas - PDF - PNG/JPEG | ✔ | ✔ |
| Advanced export/import functionality  - BPMN 2.0 XML - Visio VSDX | ✔ |  |
| Large collection of demos | ✔ | ✔ |

‍

Thank you for investing several minutes of your time to research which one of the two leading diagramming libraries would better suit your needs. Since you were so thorough with your exploration, **we would like to extend to you** [**an invitation to our no-commitment 30-day trial**](https://www.jointjs.com/free-trial). It will allow you to experience the advanced JointJS+ diagramming library for yourself and explore how its features can be seamlessly integrated with your project.
