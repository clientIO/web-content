---
source: https://www.jointjs.com/html-diagrams
generated: 2026-04-02
format: markdown
---

# Incorporate interactive diagrams into your HTML using a professional library

Leverage the SVG functionality of our powerful diagramming toolkit to build AI-powered visual applications.

[start free trial](/free-trial)

## One library, unlimited UIs

Enjoy AI workflow editors, mind maps, kanban boards and other diagramming studios directly inside your HTML application. Benefit from our app templates and reduce your development time to days.
...
## Seamless integration of JointJS+ & HTML

See how to embed our library in HTML code, demonstrated with a basic diagram that contains two linked elements.

Get the most out of the combination of JavaScript and HTML. Incorporate JointJS+ code anywhere in your application and extend it with advanced diagramming features.

[read our tutorial](https://resources.jointjs.com/)
