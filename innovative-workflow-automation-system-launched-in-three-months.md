...
JointJS+ is the foundation of Appmixer's flexible frontend that enables SaaS companies to embed [the workflow automation designer](https://www.appmixer.com/product/workflow-automation) or [integration templates](https://www.appmixer.com/product/embedded-ipaas) into their applications. Embedding can be done via the JavaScript SDK, allowing full customization and offering no security risks compared to iframes or other methods.
